---
title: "ceceg27_PeerCommentary_nirmitin"
author: "Nirmiti Naik"
date: "11/18/2021"
...
**This step looks really handy since it can get confusing when we're dealing with variables with such long names.-NN**
```{r}
hr<-e$HomeRange_km2
...
**I used almost the same code and I consulted an external resource to see how to bootstrap and use the (data, indices) part of the code. Nice job! -NN**
```{r}
library(boot)
?boot()
...
**I had the exact same issue as your 2nd challenge, what I did to solve it was utilise another parameter of the boot.ci function which was index -> this allowed me to index B0 and B1 separately to get their individual CI values. -NN**
